...
## Usage
Please see [godoc.org](http://godoc.org/github.com/fangli/gatt) for documentation.
...
Please check [#32](https://github.com/fangli/gatt/issues/32) for the status of this issue.
